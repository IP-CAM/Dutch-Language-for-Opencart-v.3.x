...
$_['text_empty']             = 'U heeft nog geen producten in uw winkelwagen.';
$_['text_day']               = 'dag';
$_['text_week']              = 'week';
$_['text_semi_month']        = 'halve maand';
$_['text_month']             = 'maand';
$_['text_year']              = 'jaar';
$_['text_trial']       		 = 'U betaalt %s elke %s %s gedurende %d betaling(en)dan ';
$_['text_recurring']   		 = '%s elke %s %s(en)';
$_['text_recurring_item']    = 'Terugkerend betaling(en)';
$_['text_payment_recurring'] = 'Betalingsprofiel';
$_['text_trial_description'] = 'U betaalt %s elke %d %s(en) gedurende %d betaling(en) dan';
...
// Error
$_['error_stock'] = 'Producten gemarkeerd met *** zijn niet beschikbaar in de gewenste hoeveelheid of op voorraad!';
$_['error_minimum'] = 'Minimaal order aantal %s is %s!';
$_['error_required'] = '%s verplicht!';
$_['error_product'] = 'Let op: Er zijn geen producten in de winkelwagen!';
